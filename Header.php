...
>>>>>>> c04c4842d6ab5da88a86f9306de680ef5411bfc5
        ...
        <!-- HEADER WIith contact information and link to fb.
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    <div class="button navbar-right">
                        ...
                        <button class="navbar-btn nav-button wow fadeInRight" onclick=" window.open('submit-property.html')" data-wow-delay="0.45s">Register</button>
                    </div>
                    <ul class="main-nav nav navbar-nav navbar-right">
                    	<li class="wow fadeInDown" data-wow-delay="0.1s"><a class="" href="index.html">Home</a></li>
                    	<li class="wow fadeInDown" data-wow-delay="0.2s"><a class="" href="">About Us</a></li>
                    	<li class="wow fadeInDown" data-wow-delay="0.2s"><a class="" href="">Events</a></li>
                    	<li class="wow fadeInDown" data-wow-delay="0.2s"><a class="" href="">Organizations</a></li>
